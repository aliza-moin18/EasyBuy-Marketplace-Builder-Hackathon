...
//     { id: 9, title: "Scelerisque dignissim", price: 69.99, image: "/Shop/shop4.jpeg", rating: 3 },
//   ];
...
//   const discountOffers = ["10% Off", "20% Off", "30% Off"];
//   const ratingFilters = [
//     { rating: 4, count: 12 },
//     { rating: 3, count: 18 },
//     { rating: 2, count: 25 }
//   ];
//   const categories = ["Accessories", "Apparel", "Shoes", "Bags"];
...
//               {/* Product Image */}
//               <div className="flex justify-center items-center sm:w-1/1">
//                 <Image src={product.image} alt={product.title} width={200} height={200} className="object-cover rounded-lg" />
//               </div>

//               {/* Product Details */}
//               <div className="flex flex-col sm:w-1/2 sm:pl-10 mt-8 sm:mt-0">
